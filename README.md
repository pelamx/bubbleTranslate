...
| **Windows** | [`bubbleTranslate-windows-x64.zip`](https://github.com/pelamx/bubbleTranslate/releases/download/v0.2.6/bubbleTranslate-windows-x64.zip) (7 MB, Windows 10 and 11) — or the [bare `.exe`](https://github.com/pelamx/bubbleTranslate/releases/download/v0.2.6/bubbleTranslate.exe) (17 MB) | One executable to double-click |
